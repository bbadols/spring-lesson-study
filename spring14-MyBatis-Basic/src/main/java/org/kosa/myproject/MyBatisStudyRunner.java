...
//		System.out.println(member); // 회원 정보 toString이 출력: 이강인 정보가 출력
...
//		System.out.println("수정 후: "+memberMapper.findMemberById("mybatis"));
		...
		System.out.println("삭제: "+deleteResult); // 삭제1
		System.out.println(memberMapper.findMemberById(id)); //결과 null값
