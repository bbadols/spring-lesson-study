...
public class MyBatisProductDynamicStudyRunner implements CommandLineRunner{
	...
	// ProductMapper를 DI 받는다 : private final field에 constructor injection
	...
	void testDynamicUpdate() {
		...
		if(targetProduct !=null) {
			...
			System.out.print("업데이트 여부(1이면 성공)"+ updateCount);
			System.out.print("업데이트 후 상품 : "+ productMapper.findProductById(2L));
		}
	}
	/*
	 	1. Dynamic SQL을 이용한 검색 기능 테스트
	*/
...
//		printSearchResult(list);
		...
		// 6. maker와 productName 일부와 가격 구간으로 복합 검색
