...
//		System.out.println("DirectorStudyRunner");
		/**
		 	...
		 	아래 메서드가 정상적으로 수행하여 출력될 수 있도록 구현
		 */
...
//			System.out.println(director);
		...
		// 통계 sql 조회
//		List<Map<String,Object>> list = directorMapper.findDirectorStatics();
//		for(Map<String,Object> map:list) {
//			//ROUND(AVG(m.attendance),0) AS averageAttendance 와 AS로 별칭을 준 이름이 map의 ket로 반환된다
